...
polyspace-bug-finder-nodesktop.exe -options-file "%WSP%\Demo_1\target.opts" -options-file "%WSP%\Demo_1\%PROG%.psopts" -results-dir "%WSP%\R_BF_%BUILD_NUMBER%"   ||  EXIT /B 200
